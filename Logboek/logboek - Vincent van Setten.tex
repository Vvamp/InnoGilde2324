...
\begin{minipage}{\textwidth}
  \centering
  \fbox{
  \includegraphics[page=1,scale=0.7]{Appendices/Overdrachtsdocument.pdf}}
\end{minipage}
\includepdf[pages={2-},scale=0.7,frame,pagecommand={}]{Appendices/Overdrachtsdocument.pdf}
